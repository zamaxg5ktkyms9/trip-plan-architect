...
- **例:** 「青海大橋」は長門市（青海島）、「大島大橋」は周防大島町（大島郡）。これらを混同して近隣スポットのように扱うことは禁止。
...
- 例: 山口県の下関市から岩国市への移動（約150km）を「30分」とするのは物理法則違反。最低でも3時間以上必要。
...
正しい例: "江戸時代に建造された城郭。天守閣からは市街を一望できる。"
誤った例: "江戸時代に建造された城郭},{天守閣からは市街を一望できる。"`
